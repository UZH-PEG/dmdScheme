...
## Errors
```{r, results = "asis"}
print(result, level = 2, listLevel = 20, type = "summary", error = 3)
```

## Warnings
```{r, results = "asis"}
print(result, level = 2, listLevel = 20, type = "summary", error = 2)
```

## Notes
```{r, results = "asis"}
print(result, level = 2, listLevel = 20, type = "summary", error = 1)
```
