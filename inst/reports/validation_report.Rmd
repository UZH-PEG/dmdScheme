...
- `r valErr_TextErrCol("conversion of values into specified type lossless possible", result$DataFileMetaData$types$error)` [See Details](#DataFileMetadataFilesTypes)
- `r valErr_TextErrCol("values in allowedValues", result$DataFileMetaData$allowedValues$error)` [See Details](#DataFileMetaDataAllowed)
- `r valErr_TextErrCol("dataFile exists in path", result$DataFileMetaData$dataFilesExist$error)` [See Details](#DataFileExists)
- `r valErr_TextErrCol("if type == 'datetime', description has format information", result$DataFileMetaData$datetimeFormatSpecified$error)`  [See Details](#DataFileMetaDataDateTimeExists)

## <== Measurement & Treatment
- `r valErr_TextErrCol("correct values in mappingColumn in dependence on columnData", result$DataFileMetaData$mappingColumnInNameOrParameter$error)` [See details](#DataFileMetaDataMapping)

### <== data file
- `r valErr_TextErrCol("columnName in dataFileName", result$DataFileMetaData$columnInDataFile$error)` [See details](#DataFileMetaDataColumnInDataFile)
...
### `columnName` in `dataFile` {#DataFileMetaDataColumnInDataFile}
```{r}
cbind(result$DataFileMetaData$columnInDataFile$details) %>%
  kable()
```
