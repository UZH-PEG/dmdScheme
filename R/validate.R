...
#'
#' @param x object referring to a `dmdScheme` to be validatedof class \code{dmdSchemeSet_raw} as returned from \code{read_from_excel( keepData = FALSE, raw = TRUE)} or file name of an xlsx file containing the metadata.
