#' dmdScheme: A package containing the definition for a metadata scheme for Experimental Microcosm Ecological experiments.
#'
...
#' developed a metadata scheme, called \code{dmdScheme} which is focussed on one
#' homogeneous field, so that the metadata scheme is not to complex and can easiliy
#' used.
#' This package provides:
#' 1) the authorative definition of the dmdScheme
...
if(getRversion() >= "2.15.1")  utils::globalVariables(c(".", "dmdScheme", "dmdScheme_raw", "propSets"))
