...
```{r structure}
caption <- "emeScheme Properties. <span style=\'font-weight: bold; text-decoration:underline; color: blue;\' >Blue</span> properties are property sets, i.e. contain other properties, **<span style='color:black'>black</span>** properties are value properties which contain values. In round brackets, the number of occurrances per metadataset of this property."
