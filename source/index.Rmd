...
See the vignette "Description" at <a href="description.html" target="_blank">vignette 'Description'</a>.
...
devtools::install_github("Exp-Micro-Ecol-Hub/emeScheme", rev = "vx.y.z", build_opts = c("--no-resave-data"))
```
