...
In the following section, I will go through the different stages of using the `dmdScheme` via tehe web app, a local app or the R prompt. The detailed commands which have to be used can be found in Figure 1.
