...
```{r fig3, fig.show = "hold", out.width = "90%", fig.align = "center", fig.cap = "**Figure 3**: Two example tabs (Experiment and Species) from the `emeScheme` spreadsheet. The complete spreadsheet can be found in the supplemental material `emeScheme.xlsx`.", echo = FALSE}
knitr::include_graphics("./figs/Spreadsheet_01_Experiment.png")
knitr::include_graphics("./figs/Spreadsheet_02_Species.png")
```
