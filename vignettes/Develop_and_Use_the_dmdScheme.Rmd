...
```{r fig3, fig.show = "hold", out.width = "90%", fig.align = "center", fig.cap = "**Figure 3**: Some example tabs from the `emeScheme` spreadsheet. The first to contain bibliometric metadata modeled along the requirements by DataCite and the autors, while the others containmetadata about the experiment and the data files. The complete spreadsheet can be found in the supplemental material `emeScheme.xlsx`.", echo = FALSE}
knitr::include_graphics("./figs/Spreadsheet_01_MdBibliometric.png")
knitr::include_graphics("./figs/Spreadsheet_02_MdAuthor.png")
knitr::include_graphics("./figs/Spreadsheet_03_Experiment.png")
knitr::include_graphics("./figs/Spreadsheet_04_Genus.png")
knitr::include_graphics("./figs/Spreadsheet_08_DataFileMetadata.png")
```
...
knitr::include_graphics("./figs/ValidationReport.png")
```
...
```{r fig5, fig.show = "hold", out.width = "50%", fig.align = "center", fig.cap = "**Figure 5**: Create a new domain specific scheme based on dmdScheme."}
