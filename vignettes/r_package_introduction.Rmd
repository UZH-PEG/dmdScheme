...
val <- validate( system.file("dmdScheme.xlsx", package = "dmdScheme") )
```
...
dmdScheme_to_xml( system.file("dmdScheme.xlsx", package = "dmdScheme") )
```
...
dmdScheme_to_xml( system.file("dmdScheme.xlsx", package = "dmdScheme"), file = xmlFile )
```

## Re-import from xml into R

```{r example_import_xml, eval = TRUE}
xml_to_dmdScheme( xmlFile ) # system.file("dmdScheme_example.xml", package = "dmdScheme") )
```

## Importing Data from Excel Sheet

Next, you have to import the data entered in the Excel sheet into R. For simplicity, we use here a file includ in the package. If you want to load your own file, replace `system.file("dmdScheme.xlsx", package = "dmdScheme")` with the file name and path to that file.
