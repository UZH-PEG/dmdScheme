...
val <- validate( system.file("installedSchemes", paste0(scheme_default(), ".xlsx"), package = "dmdScheme") )
```
...
x <- read_excel( system.file("installedSchemes", paste0(scheme_default(), ".xlsx"), package = "dmdScheme") )
as_xml( x )
```
