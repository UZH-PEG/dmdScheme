...
1. Open an existing scheme definition you want to use as a starting point. One way to do this is to use the command:  
...
# Create an accompanying R package to extend the functionality of the `dmdScheme` package
