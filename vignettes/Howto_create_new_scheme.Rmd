...
For general uasage, we recommend to use these CRAN for production usage. If you want to try (or need) the newst features, use the drat version, and only if you want to live at the bleeding edge, and can live with crashes and untested exciting new features, use the github version. 
...
If you open the scheme definition (i.e. the excel file), you will see in the `Experiment` tab one cell containing the value **DATA exampleScheme v1.2.3**. **exampleScheme**.
