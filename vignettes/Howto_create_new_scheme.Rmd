...
This file can be edited following the limitations as specified in the **Minimum requirements for metadatascheme based on dmdScheme**. After modifications have been done, the spreadsheet can be re-imported in the source of the package by using
