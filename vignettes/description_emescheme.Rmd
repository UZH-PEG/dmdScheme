...
# The emeScheme
This document was than re-ordered and thinned which resulted in the initial verions of the emeSCheme.
...
The structure as at **`r read.dcf(here("DESCRIPTION"))[1, "emeSchemeUpdate"]` GMT** is as followed:
