...
* **mappingColumn** Here enter the ID of the *measurement* (as entered in the *Measurement* sheet, *measurementID* column), treatment ID (as entered in the *Treatment* sheet, *treatmentID* column), the species ID (as enteredin the *Species* sheet, *speciesID* column) or *NA*.
