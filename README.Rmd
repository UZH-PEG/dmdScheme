---
title: "Domain specific MetaData Scheme (dmdScheme): Package to develop and manage Domain Specific Metadata Schemes"
...
----
# dmdScheme version v`r read.dcf(here::here('DESCRIPTION'), all = TRUE)[['Version']]`
...
If you are feeling adventourous, want to live at the bleeding edge and can live with non-working features, you can install the **dev** branch. This branch is **not stable** and features and functionality can appear or be remioved without prior notice:
